...
export const Courses = () => {
  ...
  // Filtrar aulas por categoria selecionada e outros filtros
  const filteredCourses = useMemo(() => {
    return courses.filter(course => {
      // Filtro de categoria selecionada na partição
      ...
      // Filtro de categoria nos filtros
  ...
  }, [courses, userProgress, selectedCategory, searchTerm, selectedCategories, showFavoritesOnly, showCompletedOnly]);
